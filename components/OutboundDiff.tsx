...
const OutboundDiff: React.FC = () => {
  return (
    <section id="outbound" className="py-24 bg-slate-900 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          
          <div className="order-2 lg:order-1">
            <div className="relative mx-auto w-64 h-[500px] bg-slate-800 rounded-[3rem] border-8 border-slate-700 shadow-2xl p-4 flex flex-col items-center justify-center">
              {/* Screen Content */}
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-slate-500">
                ...
                <span className="text-emerald-400 font-bold">Your Brand Name</span>
              </p>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              ...
              <span className="text-blue-400">Branded Caller ID.</span>
            </h2>
            ...
            <div className="bg-slate-800/30 rounded-xl p-6 border border-slate-700 mb-8">
              ...
              <p className="text-sm text-slate-400 mb-4">
                Powered by our <span className="text-white font-semibold">Send It By Text</span> integration.
              </p>
              <div className="space-y-3">
                <div className="flex gap-3 text-sm">
                  <span className="text-blue-400 font-bold w-12 text-right">Step 1</span>
                  <span className="text-slate-300">AI calls 5,000 previous clients.</span>
                </div>
                <div className="flex gap-3 text-sm">
                  <span className="text-blue-400 font-bold w-12 text-right">Step 2</span>
                  <span className="text-slate-300">Client answers (because they see your name).</span>
                </div>
                <div className="flex gap-3 text-sm">
                  <span className="text-blue-400 font-bold w-12 text-right">Step 3</span>
                  <span className="text-slate-300">AI confirms details and texts signing link <i>while on the call</i>.</span>
                </div>
                <div className="flex gap-3 text-sm">
                  <span className="text-blue-400 font-bold w-12 text-right">Step 4</span>
                  <span className="text-slate-300">AI waits for signature confirmation before hanging up.</span>
                </div>
              </div>
            </div>
          </div>
